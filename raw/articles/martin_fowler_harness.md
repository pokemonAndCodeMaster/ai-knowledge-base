...
- https://www.twitter.com/martinfowler
- https://toot.thoughtworks.com/@mfowler
- https://www.linkedin.com/in/martin-fowler-com/
- https://bsky.app/profile/martinfowler.com
[Refactoring](https://refactoring.com)
[Agile](https://martinfowler.com/agile.html)
[Architecture](https://martinfowler.com/architecture)
[About](https://martinfowler.com/aboutMe.html)
...
- [Top](https://martinfowler.com/articles/harness-engineering.html#top)
- [Feedforward and Feedback](https://martinfowler.com/articles/harness-engineering.html#FeedforwardAndFeedback)
- [Computational vs Inferential](https://martinfowler.com/articles/harness-engineering.html#ComputationalVsInferential)
- [The steering loop](https://martinfowler.com/articles/harness-engineering.html#TheSteeringLoop)
- [Timing: Keep quality left](https://martinfowler.com/articles/harness-engineering.html#TimingKeepQualityLeft)
- [Regulation categories](https://martinfowler.com/articles/harness-engineering.html#RegulationCategories)

[Maintainability harness](https://martinfowler.com/articles/harness-engineering.html#MaintainabilityHarness)

[Architecture fitness harness](https://martinfowler.com/articles/harness-engineering.html#ArchitectureFitnessHarness)

[Behaviour harness](https://martinfowler.com/articles/harness-engineering.html#BehaviourHarness)


- [Maintainability harness](https://martinfowler.com/articles/harness-engineering.html#MaintainabilityHarness)
- [Architecture fitness harness](https://martinfowler.com/articles/harness-engineering.html#ArchitectureFitnessHarness)
- [Behaviour harness](https://martinfowler.com/articles/harness-engineering.html#BehaviourHarness)
- [Harnessability](https://martinfowler.com/articles/harness-engineering.html#Harnessability)
- [Harness templates](https://martinfowler.com/articles/harness-engineering.html#HarnessTemplates)
- [The role of the human](https://martinfowler.com/articles/harness-engineering.html#TheRoleOfTheHuman)
- [A starting point - and open questions](https://martinfowler.com/articles/harness-engineering.html#AStartingPoint-AndOpenQuestions)
[Top](https://martinfowler.com/articles/harness-engineering.html#top)
[Feedforward and Feedback](https://martinfowler.com/articles/harness-engineering.html#FeedforwardAndFeedback)
[Computational vs Inferential](https://martinfowler.com/articles/harness-engineering.html#ComputationalVsInferential)
[The steering loop](https://martinfowler.com/articles/harness-engineering.html#TheSteeringLoop)
...
- [Metaphors only go so far](https://martinfowler.com/articles/harness-engineering.html#MetaphorsOnlyGoSoFar)
- [How does harness engineering relate to context engineering?](https://martinfowler.com/articles/harness-engineering.html#HowDoesHarnessEngineeringRelateToContextEngineering)
- [Ambient affordances](https://martinfowler.com/articles/harness-engineering.html#AmbientAffordances)
- [Ashby's Law](https://martinfowler.com/articles/harness-engineering.html#AshbysLaw)
[Metaphors only go so far](https://martinfowler.com/articles/harness-engineering.html#MetaphorsOnlyGoSoFar)
[How does harness engineering relate to context engineering?](https://martinfowler.com/articles/harness-engineering.html#HowDoesHarnessEngineeringRelateToContextEngineering)
[Ambient affordances](https://martinfowler.com/articles/harness-engineering.html#AmbientAffordances)
[Ashby's Law](https://martinfowler.com/articles/harness-engineering.html#AshbysLaw)
...
[Ambient affordances](https://martinfowler.com/articles/harness-engineering.html#AmbientAffordances)
[Ashby's Law](https://martinfowler.com/articles/harness-engineering.html#AshbysLaw)
This article [updates an earlier memo](https://martinfowler.com/articles/exploring-gen-ai/harness-engineering-memo.html) outlining my first impressions of harness engineering.
...
[Context engineering](https://martinfowler.com/articles/exploring-gen-ai/context-engineering-coding-agents.html) provides us with the means to make guides and sensors available to the agent. Engineering a user harness for a coding agent is a specific form of context engineering.
...
[An OpenAI team documented what their harness looks like](https://openai.com/index/harness-engineering/)
[Stripe's write-up about their minions](https://stripe.dev/blog/minions-stripes-one-shot-end-to-end-coding-agents)
